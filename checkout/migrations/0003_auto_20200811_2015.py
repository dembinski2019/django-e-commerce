# Generated by Django 3.0.8 on 2020-08-11 23:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('checkout', '0002_auto_20200806_2012'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('pagueseguro', 'PagSeguro'), ('paypal', 'Paypal')], max_length=20, verbose_name='Opções de Pagamento')),
        ...
        migrations.AlterModelOptions(
            name='cartitem',
            options={'ordering': ['product'], 'verbose_name': 'Item do Carrinho', 'verbose_name_plural': 'Itens dos Carrinhos'},
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
